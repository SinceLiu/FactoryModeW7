...
public class PressureSensor extends BaseTestActivity implements SensorEventListener {
  ...
  private Button mBtFailed;
	...
	getActionBar().setBackgroundDrawable(new ColorDrawable(Color.BLACK));
        ...
        mSensorName.setText(R.string.air_pressure_sensor_name);
        
        mSensorManager = (SensorManager) getSystemService(Context.SENSOR_SERVICE);
        
				// Pressure Sensor
				mPressureSensor = mSensorManager
						.getDefaultSensor(Sensor.TYPE_PRESSURE);
				registerSensor(mPressureSensor);
	...
	public View.OnClickListener cl = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Utils.SetPreferences(getApplicationContext(), mSp, R.string.air_pressure_sensor_name,
	...
	public void onSensorChanged(SensorEvent event) {
		...
		case Sensor.TYPE_PRESSURE:
			mSensorValue.setText("value: " + event.values[0] + " Pa");
			break;
