...
public class PulseSensor extends BaseTestActivity implements SensorEventListener {
	...
	ActionBar.LayoutParams lp =new  ActionBar.LayoutParams(
     ...
     /*   mSensorName.setText(R.string.pulse_sensor_name);
        
        mSensorManager = (SensorManager) getSystemService(Context.SENSOR_SERVICE);
        
				// Gyroscope Sensor
				mPulseSensor = mSensorManager
						.getDefaultSensor(Sensor.TYPE_GYROSCOPE);
				registerSensor(mPulseSensor);*/
        Intent heartRatioIntent = new Intent(Intent.ACTION_MAIN);

        if(SystemProperties.getBoolean("heart_rate_test_style", false)) {
            mTestName.setText(R.string.fixture_text);
            heartRatioIntent.setClassName("com.cenon.heartrate", "com.cenon.heartrate.HeartRateMonitorActivity");
        } else {
            mTestName.setText(R.string.patch_test);
            heartRatioIntent.setClassName("com.cenon.heartrate", "com.cenon.heartrate.test.HeartRateTestActivity");
        }
        startActivityForResult(heartRatioIntent, AppDefine.FT_HEARTRATE);
	...
	public View.OnClickListener cl = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Utils.SetPreferences(getApplicationContext(), mSp, R.string.pulse_sensor_name,
