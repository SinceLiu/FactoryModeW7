...
public class TsVerifyLine extends BaseTestActivity implements View.OnTouchListener {
...
//                    }
            ...
            private void doDraw(Canvas canvas) {
                ...
                try {
                    ...
                    Log.v(TAG, "mPts1 ArrayIndexOutOfBoundsException: " + e.getMessage());
                    return;
                }
                ...
                try {
                    ...
                    Log.v(TAG, "mInput ArrayIndexOutOfBoundsException: "
                            + e.getMessage());
                    return;
                }
