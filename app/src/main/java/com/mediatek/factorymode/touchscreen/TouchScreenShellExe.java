...
public class TouchScreenShellExe {
    ...
    public static String getOutput() {
        Log.i(TAG, "getOutPut:sb-- " + sResult);
    ...
    public static int execCommand(String[] command) throws IOException {
        ...
        try {
            if (proc.waitFor() == 0) {
                ...
                // sb.append(ERROR);
                Log.i(TAG, "exit value = " + proc.exitValue() + "|| get:sb-- "
                        + sResult);
                return -1;
            }
        } catch (InterruptedException e) {
            Log.i(TAG, "exe fail " + e.toString() + "|| get:sb-- " + sResult);
            // sb.append(ERROR);
            ...
            if (null != bufferedreader) {
                try {
                    ...
                    Log.w(TAG, "close IOException: " + e.getMessage());
                }
            }
        }
    }
