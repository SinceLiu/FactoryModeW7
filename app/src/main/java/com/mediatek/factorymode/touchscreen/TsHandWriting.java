...
public class TsHandWriting extends BaseTestActivity {
...
//        }
    ...
    public class MyView extends View {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            Log.v(TAG, "Metrics: ascent=" + mTextMetrics.ascent + " descent="
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(w * 2, 0, (w * 2) + (mCurPressure * w) - 1, bottom,
                    mTextLevelPaint);
            Log.w(TAG, "mCurPressure = " + mCurPressure);
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            Log.w(TAG, "event.getPressure()= " + mCurPressure);
